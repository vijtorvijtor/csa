...
// $conn = mysql_connect($dbhost, $dbuser, $dbpass);
   ...
   $sCampos=" (idNV INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
      ...
      fechaPromesa DATE,
      total FLOAT,
      parcial1 FLOAT, fParcial1 DATETIME, idUser1 INT,
      parcial2 FLOAT, fParcial2 DATETIME, idUser2 INT,
      parcial3 FLOAT, fParcial3 DATETIME, idUser3 INT,
      parcial4 FLOAT, fParcial4 DATETIME, idUser4 INT,
      parcial5 FLOAT, fParcial5 DATETIME, idUser5 INT,
      parcial6 FLOAT, fParcial6 DATETIME, idUser6 INT,
      parcial7 FLOAT, fParcial7 DATETIME, idUser7 INT,
      parcial8 FLOAT, fParcial8 DATETIME, idUser8 INT,
      parcial9 FLOAT, fParcial9 DATETIME, idUser9 INT,
      parcial10 FLOAT, fParcial10 DATETIME, idUser10 INT);";
   creaTabla($conn,$sTabla,$sCampos);
